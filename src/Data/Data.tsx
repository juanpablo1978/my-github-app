...
export const itemsPackages = [
    {
      id: 1,
      icon: <FaDocker  className="text-[18px] text-blue-600" />,
      title: "Docker",
    ...
    {
      id: 2,
      icon: <SiApache className="text-[18px] text-orange-800" />,
      title: "Apache Maven",
    ...
    {
      id: 3,
      icon: <SiNuget className="text-[18px] text-blue-900" />,
      title: "NuGet",
    ...
    {
      id: 4,
      icon: < SiRubygems className="text-[18px] text-orange-800" />,
      title: " RubyGems",
    ...
    {
      id: 5,
      icon: <FaNpm className="text-[18px] text-red-600" />,
      title: "npm",
    ...
    {
        id: 6,
        icon: <GoContainer  className="text-[18px] text-white" />,
        title: "Containers",
  ...
  export const popularRepositories = [
    {
      ...
      language: "JavaScript",
      icon: <GiPlainCircle className="w-3 h-3 bg-yellow-300"/>
    },
    {
      id: 2,
    ...
    },
    {
      ...
      language: "HTML",
      icon: <GiPlainCircle className="w-3 h-3 bg-orange-600"/>
    },
    {
      id: 4,
      title: "e-commerce",
