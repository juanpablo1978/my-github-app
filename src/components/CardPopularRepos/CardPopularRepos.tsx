...
const CardPopularRepos: React.FC<CardPopularProps> = ({
  title,
  visibility,
  description,
  language,
  ...
  return (
    <article className="w-[355px] h-[120px] lg:w-[435px] border-[1px] border-gray-500 rounded-md p-3">
      <div className="flex justify-between mb-3">
        <h3 className="text-blue-500 font-normal text-[15px]">{title}</h3>
      ...
      <div className="flex items-center gap-x-1">
        <span>
          <Icon className={iconClassName || "w-3 h-3 text-yellow-300"} />
        </span>
