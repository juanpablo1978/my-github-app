...
const Archievements = () => {
  return (
    <div className="text-white text-[16px] font-semibold py-4 lg:py-0 pl-3 lg:w-56">
    ...
    <div className="w-[33px] h-[22px] text-black bg-red-200 rounded-[12px] cursor-pointer
     flex justify-center items-center text-[11px] absolute left-12 top-96 lg:left-[256px] lg:top-[712px]">
      <p>x2</p>
    </div>
  </div>
  )
